...
class TestInOutVariables(TestBase):
    ...
    def check_class_internal (self,ivar_value,ovar_value, use_expression, is_wrapped):
        if use_expression:
    ...
    def do_test(self):
        ...
        # Set the breakpoints
        class_bkpt = target.BreakpointCreateBySourceRegex('Set breakpoint here for Class access', self.main_source_spec)
